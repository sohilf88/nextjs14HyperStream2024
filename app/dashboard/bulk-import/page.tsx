...
async function onFormSubmit(formData:FormData){
  ...
  return (
    ...
    <form action={onFormSubmit}  className="max-w-2xl w-full flex flex-col gap-4 h-72 items-center justify-center border rounded mx-3">
    ...
    < input required accept=".csv" type="file" name="file" id="large-file-input" className="block max-w-lg w-full border  shadow-sm rounded-lg text-sm focus:z-10 border-zinc-100 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none
