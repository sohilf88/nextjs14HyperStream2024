...
const PaginationControls: FC<PaginationControlsProps> = (
  ...
  <div className="flex flex-row mx-auto">
    ...
    disabled={!hasPrevPage}
     ...
     type="button" className="bg-zinc-700 shadow-2xl text-white rounded-l-md border-r-4 border-gray-100 py-2 hover:bg-red-700 hover:text-white px-3 disabled:bg-zinc-500 disabled:text-zinc-700 disabled:cursor-not-allowed">
    ...
    type="button" className={`bg-zinc-700 shadow-2xl  text-white rounded-r-md py-2 border-l-4 border-gray-200 hover:bg-red-700 hover:text-white px-3 disabled:bg-zinc-500 disabled:text-zinc-700 disabled:cursor-not-allowed`}>
      <div className="flex flex-row align-middle">
